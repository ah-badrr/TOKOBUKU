                ...
                <div class="row column_title">
                    <div class="col-md-12">
                        <div class="page_title">
                            ...
                            <h2 style="width: max-content">Tambah Data Penerbit</h2>
                        </div>
                    </div>
                </div>
                                    ...
                                    <form class="padding_infor_info row" method="POST">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="kode" type="text" class="form-control" value="" name="kode" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="nama" class="form-label">Nama <span class="text-danger small">*</span></label>
                                                <input id="nama" type="text" class="form-control" value="" name="nama" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="alamat" class="form-label">Alamat <span class="text-danger small">*</span></label>
                                                <input id="alamat" type="text" class="form-control" value="" name="alamat" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="kota" class="form-label">Kota <span class="text-danger small">*</span></label>
                                                <input id="kota" type="text" class="form-control" value="" name="kota" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="telepon" class="form-label">Telepon <span class="text-danger small">*</span></label>
                                                <input id="telepon" type="number" class="form-control" value="" name="telepon" required>
                                            </div>
                                        </div>
                                        <div class="col-12 mt-4">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary" name="create"><i class="fa fa-save mr-1"></i> Submit</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
