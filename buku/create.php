                                    ...
                                    <form class="padding_infor_info row" method="POST">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="kategori" type="text" class="form-control" value="" name="kategori" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="nama_buku" class="form-label">Nama Buku <span class="text-danger small">*</span></label>
                                                <input id="nama_buku" type="text" class="form-control" value="" name="nama_buku" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="harga" class="form-label">harga <span class="text-danger small">*</span></label>
                                                <input id="harga" type="number" class="form-control" value="" name="harga" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label for="stok" class="form-label">Stok <span class="text-danger small">*</span></label>
                                                <input id="stok" type="number" class="form-control" value="" name="stok" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
