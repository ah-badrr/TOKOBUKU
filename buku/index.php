...
<body class="dashboard dashboard_1">
    ...
    if (isset($_SESSION["created"])) {
     ...
     swal({
        ...
        text: 'Tambah data buku berhasil!',
        icon: 'success',
        button: 'ok',
      });
    </script>";
                                                    ...
                                                    foreach ($buku as $b) { ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-right d-flex justify-content-end">
                                                                <a class="btn btn-warning" href="edit.php?id=<?= $b['id'] ?>"><i class="fa fa-pencil"></i></a>
                                                                <a class="btn btn-danger" href="destroy.php?id=<?= $b['id'] ?>"><i class="fa fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                    <?php }
