...
if (isset($_GET['search']) or isset($_GET['cari'])) {
    $search = $_GET['search'];
    $cari = "SELECT penerbit.nama AS np, buku.* FROM buku INNER JOIN penerbit ON buku.penerbit = penerbit.id
    WHERE nama_buku LIKE '%$search%' ";

    $buku = mysqli_query($conn, $cari);
                ...
                <div class="row column_title">
                    <div class="col-md-12">
                        <div class="page_title">
                            ...
                            <h2 style="width: max-content">Selamat Datang di TOKO BUKU</h2>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="float-right heading1 margin_0">
                                            <form class="float-end" action="" method="GET">
                                                <div class="input-group">
                                                    <input type="search" value="" name="search" class="rounded form-control me-1" placeholder="Search...">
                                                    <button class="rounded btn btn-success" name="cari" type="submit" id="button-addon2">
